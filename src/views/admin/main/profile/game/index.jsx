...
export default function Track(props) {
  ...
  const [swiperData, setSwiperData] = useState( [
    ...
    },
    {
        ...
        "volume": "353602828",
        "gameIntroduction": "Explore LANDs owned by users to experience incredible scenes and structures. From a space adventure to a medieval dungeon maze to entire villages crafted from the minds of community members.",
        "totalNFT": 90601,
    ...
    },
    {
        ...
        "gameStudio": "Wolffun",
        "volume": "907636",
        "gameIntroduction": "Earn your NFTs item by playing the game and sell it on the marketplace to make money",
        "totalNFT": 0,
      ...
      <Flex justifyContent="center">
        ...
        >
          <Box className="swiper-wrapper">
            {swiperData.length && swiperData.map((item, index) => {
              return (
                <Box className="swiper-slide">
                  ...
                  >
                    <Box>
                      <Image width="249px"  borderRadius= '26px' height="238px" src={item.imgs[0].url} alt="" />
                    </Box>
