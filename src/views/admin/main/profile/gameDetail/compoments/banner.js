  ...
  return (
    <div>
      ...
      <Box bg="#111C44" borderRadius="32px">
        ...
        <Box p={{ md: "20px 10px", "2xl": "40px 49px 23px 32px" }} borderBottom="1px solid  rgba(228, 228, 228,0.1)">
          <Badge variant="solid" minWidth="92px" height="26px" textAlign="center" fontSize="13px" fontWeight="400" colorScheme="green" >
            Alpha
          </Badge>
          ...
          <Flex justifyContent="space-between" flexDirection={{ base: "column", xl: "row" }} >
            <Flex alignItems="center">
              <Image src={avatar1} width="82px" height="82px"></Image>
            ...
            <Box>
              <Button variant="brand" width="180px" bgColor="#6C5DD3"
                height="56px" m="32px auto" fontWeight="500" fontSize="25.2px">Play Now!</Button>
            </Box>
          </Flex>
        </Box>
        <Flex p="25px 34px">
      ...
      <Flex bg="rgba(228, 228, 228, 0.1)" margin="60px 0" borderRadius="16px" position="relative" flexDirection={{ base: 'column;', xl: "inherit", }}>
        <Box width={{
          base: '100%',
          xl: "25%",
        }} p={{
        ...
        <Box width={{
          ...
          <Text fontSize={{
            base: 'xl',
            xl: "3xl",
          }} fontWeight="600" letterSpacing="-1px">Ξ 15.545
        ...
        <Box width={{
          ...
          <Text fontSize={{
            base: 'xl',
            xl: "3xl",
          }} fontWeight="600" letterSpacing="-1px">13,543</Text>
        </Box>
        <Box style={{
          position: "absolute",
          bottom: "10px",
      ...
      <Flex border='1px solid rgba(228, 228, 228, 0.1)' borderRight="0px" borderLeft="0px" padding="42px 0 29px 0" justifyContent="space-between">
        <Box width="48%">
        ...
        <Box width="48%" fontSize="13px" color="#B2B3BD" pt="10px">
          <Flex mb="20px">
            <Box height="1px" width="50%" borderRight="1px" bgColor="#FF9A7B"></Box>
            <Box height="1px" width="50%" borderRight="1px" bgColor="#6C5DD3"></Box>
          </Flex>
          <Flex justifyContent="space-between" fontSize="13px" color="#B2B3BD" >
            <Text> 50% To da &nbsp;👍 <Text>moon</Text></Text>
